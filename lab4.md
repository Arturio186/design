...
![Взять карты](<./images/Interaction Diagrams/Взять.png>)
...
![Завершить ход](<./images/Interaction Diagrams/Завершить.png>)
...
![Отбить карту](<./images/Interaction Diagrams/Отбить.png>)
